...
template <> constexpr inline auto Client::qt_create_metaobjectdata<qt_meta_tag_ZN6ClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'stepReceived'
        QtMocHelpers::SignalData<void(const StepPacket &)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
        // Slot 'onReadyRead'
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->stepReceived((*reinterpret_cast<std::add_pointer_t<StepPacket>>(_a[1]))); break;
        case 2: _t->onReadyRead(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Client::*)()>(_a, &Client::connectedOk, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Client::*)(const StepPacket & )>(_a, &Client::stepReceived, 1))
            return;
    }
}
...
// SIGNAL 0
void Client::connectedOk()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Client::stepReceived(const StepPacket & _t1)
{
