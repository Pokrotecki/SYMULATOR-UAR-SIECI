...
template <> constexpr inline auto Server::qt_create_metaobjectdata<qt_meta_tag_ZN6ServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const ConfigPacket &)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->configReceived((*reinterpret_cast<std::add_pointer_t<ConfigPacket>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Server::*)()>(_a, &Server::connectedOk, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Server::*)(const ConfigPacket & )>(_a, &Server::configReceived, 1))
            return;
    }
}
...
// SIGNAL 0
void Server::connectedOk()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Server::configReceived(const ConfigPacket & _t1)
{
