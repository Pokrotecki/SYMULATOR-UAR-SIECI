...
template <> constexpr inline auto Client::qt_create_metaobjectdata<qt_meta_tag_ZN6ClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'sendStep'
        QtMocHelpers::SlotData<void(const StepPacket &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'onReadyRead'
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sendStep((*reinterpret_cast<std::add_pointer_t<StepPacket>>(_a[1]))); break;
